...
# def modifyCal(ele_attri,ele_level,cal_select,zkbtn_ele,i):
#     time.sleep(1)
#     ipMethod.ac.click(ele_attri, ele_level)
#     calele=ipMethod.find_element(ele_attri, cal_select)
#     if len(calele)==0:
#         ipMethod.ac_click(ele_attri,zkbtn_ele)
#         ipMethod.ac_click(ele_attri, cal_select)
#         select_calmethod(i)
#         ipMethod.click(ele_attri, menu_confirmbtn)
#     else:
#         ipMethod.ac_click(ele_attri, cal_select)
...
# def select_calmethod(i):
#     if  ipMethod.find_element("id","function").is_selected():
#         if i==1:
#             ipMethod.click("xpath", '//*[@id="function-type"]/option[1]')
#         elif i==2:
#             ipMethod.click("xpath", '//*[@id="function-type"]/option[2]')
#         elif i==3:
#             ipMethod.click("xpath", '//*[@id="function-type"]/option[3]')
#         else:
#             ipMethod.click("xpath", '//*[@id="function-type"]/option[4]')
#     elif ipMethod.find_element("id","script").is_selected():
#         print(111)
